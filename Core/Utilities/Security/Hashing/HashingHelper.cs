...
namespace Core.Utilities.Security.Hashing
{
    ...
    {
        public static void CreatePasswordHash(string pasword, out byte[] passwordHash, out byte[] passwordSalt)
        {
        ...
        // Şifre doğrularken alınıan şifre hash lenip byte [] olarak karşılaştırılsın.        
